...
public class QInquiryImg extends EntityPathBase<InquiryImg> {
    ...
    private static final long serialVersionUID = 367006536L;
    ...
    public final QMemberInquiry inquiry;
    ...
    public QInquiryImg(Class<? extends InquiryImg> type, PathMetadata metadata, PathInits inits) {
        ...
        this.inquiry = inits.isInitialized("inquiry") ? new QMemberInquiry(forProperty("inquiry"), inits.get("inquiry")) : null;
    }
